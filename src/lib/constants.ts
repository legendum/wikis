...
export const OLLAMA_URL =
  process.env.OLLAMA_URL || (rawConfig.ollama_url as string) || "http://localhost:11434";
...
export const SEARCH_VECTOR_WEIGHT = Number(rawConfig.search_vector_weight || 0.3);
export const SEARCH_DEFAULT_LIMIT = Number(rawConfig.search_default_limit || 20);
