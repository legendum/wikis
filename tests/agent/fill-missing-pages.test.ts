...
describe("fillMissingPages link extraction", () => {
  ...
  it("ignores links to index.md and log.md", () => {
    db.prepare(
      ...
      wikiId,
      "overview.md",
      "Back to [Index](index.md) or see [Changelog](log.md).",
      "a",
      "2026-01-01",
    );
  ...
  it("deduplicates links referenced from multiple pages", () => {
    ...
    db.prepare(
      ...
      wikiId,
      "setup.md",
      "Edit [Config](config.md) to customize.",
      "b",
      "2026-01-01",
    );
  ...
  it("finds multiple missing links from a single page", () => {
    const content =
      "See [Auth](auth.md) and [Deploy](deploy.md) and [Monitor](monitor.md).";
  ...
  it("ignores non-.md links", () => {
    db.prepare(
      ...
      wikiId,
      "overview.md",
      "See [Repo](https://github.com/foo/bar) and [Image](logo.png).",
      "a",
      "2026-01-01",
    );
